...
def get_regression_results(dependent_var_list, independent_var_combinations_list, realized_vols):
    ...
    columns_list = ['R Square', 'ADF Stat', '1%', '5%', '10%', 'Intercept']
    ...
    for dependent_var in dependent_var_list:
        ...
        for independent_var in independent_var_combinations_list:
            ...
            adf_results = adfuller(reg_model.resid)

            # Structure results
            multi_index_structure[counter, 0] = reg_model.rsquared
            ...
            multi_index_structure[counter, 5:5+len(reg_model.params)] = reg_model.params
            counter += 1
